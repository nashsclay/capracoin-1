...
SOURCES += src/activemasternode.cpp \
           ...
           src/Darksend.cpp \
           src/capracoin-cli.cpp \
           src/capracoin-tx.cpp \
           src/capracoin.cpp \
           src/db.cpp \
           ...
           src/qt/capracoin.cpp \
           src/qt/capracoinstrings.cpp \
...
RESOURCES += src/qt/capracoin.qrc src/qt/capracoin_locale.qrc

TRANSLATIONS += src/qt/locale/capracoin_bg.ts \
                src/qt/locale/capracoin_de.ts \
                src/qt/locale/capracoin_en.ts \
                src/qt/locale/capracoin_es.ts \
                src/qt/locale/capracoin_fi.ts \
                src/qt/locale/capracoin_fr.ts \
                src/qt/locale/capracoin_it.ts \
                src/qt/locale/capracoin_ja.ts \
                src/qt/locale/capracoin_pl.ts \
                src/qt/locale/capracoin_pt.ts \
                src/qt/locale/capracoin_ru.ts \
                src/qt/locale/capracoin_sk.ts \
                src/qt/locale/capracoin_sv.ts \
                src/qt/locale/capracoin_vi.ts \
                src/qt/locale/capracoin_zh_CN.ts \
                src/qt/locale/capracoin_zh_TW.ts
