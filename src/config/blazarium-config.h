/* src/config/capracoin-config.h.  Generated from capracoin-config.h.in by configure.  */
/* src/config/capracoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CPRA_CONFIG_H

#define CPRA_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://capracoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CapraCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CapraCoin Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "capracoin"
