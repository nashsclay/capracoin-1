...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CapraCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CapraCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CPRA features */
        {"capracoin", "masternode", &masternode, true, true, false},
        {"capracoin", "masternodelist", &masternodelist, true, true, false},
        {"capracoin", "mnbudget", &mnbudget, true, true, false},
        {"capracoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"capracoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"capracoin", "mnsync", &mnsync, true, true, false},
        {"capracoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"capracoin", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use capracoind, or the -server option to capracoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"CapraCoin Alert\" admin@foo.com\n"),
...
{
    return "> capracoin-cli " + methodname + " " + args + "\n";
}
