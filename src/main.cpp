...
#if defined(NDEBUG)
#error "CapraCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "CapraCoin Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 1) return 2800000 * COIN;
...
{
    RenameThread("capracoin-scriptch");
