...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CapraCoin Core capracoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  capracoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded capracoin transaction") + "\n" +
                               "  capracoin-tx [options] -create [commands]   " + _("Create hex-encoded capracoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded capracoin transaction
