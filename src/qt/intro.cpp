...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CapraCoin Core"),
     ...
     * override -datadir in the capracoin.conf file in the default data directory
     * (to be consistent with capracoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
