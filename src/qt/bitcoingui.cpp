                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CapraCoin-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CapraCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and capracoin: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CapraCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about CapraCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CapraCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CapraCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CapraCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a CapraCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CapraCoin Core help message to get a list with possible CapraCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CapraCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CapraCoin network", "", count));
}
...
{
    QString strTitle = tr("CapraCoin Core"); // default title
