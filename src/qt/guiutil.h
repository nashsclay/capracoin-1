...
/** Utility functions used by the CPRA Qt UI.
 */
namespace GUIUtil
{
...
// Render CPRA addresses in monospace font
...
// Parse "capracoin:" URI into recipient object, return true on successful parsing
