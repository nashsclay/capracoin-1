...
This mechanism has been integrated into Bitcore-Node-CapraCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CapraCoincoin/insight-api-CapraCoin#web-socket-api](https://github.com/CapraCoincoin/insight-api-CapraCoin#web-socket-api) 
* API: [https://github.com/CapraCoincoin/insight-api-CapraCoin#instantsend-transactions](https://github.com/CapraCoincoin/insight-api-CapraCoin#instantsend-transactions) 
...
By default, the CapraCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CapraCoin Core daemon:
