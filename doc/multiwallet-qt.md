...
Only requiring some minor changes is CapraCoin.cpp.
...
Changes to CapraCoin.cpp
----------------------
CapraCoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
